...
const getLibroById = async (req, res) => {
  try {
    ...
    if (!libro) return res.status(404).json({ error: 'El libro no fue encontrado.' });
    res.json(libro);
  } catch (error) {
...
const updateLibro = async (req, res) => {
  try {
    ...
    if (!libroActualizado) return res.status(404).json({ error: 'El libro no fue encontrado.' });
...
const deleteLibro = async (req, res) => {
  try {
    ...
    if (!eliminado) return res.status(404).json({ error: 'El libro no fue encontrado.' });
